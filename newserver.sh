...
useradd -m -s /bin/bash almexuser
echo "almexuser:$PASS" | chpasswd
usermod -aG sudo almexuser
...
echo "              reboot"
echo " "
echo " Then log back in with your new almexuser account to complete the installation."
echo " "
